  ...
  return (
    <div className="py-6">
      ...
      {loading ? (
        ...
        <div className="mt-6 rounded-lg bg-white dark:bg-dark-card p-6 shadow border border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Willkommen beim Rehasport Management System</h2>
        ...
        <>
          <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div className="dashboard-stat">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Patienten</dt>
                      <dd>
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 px-5 py-3 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="dashboard-stat">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Aktive Kurse</dt>
                      <dd>
                        <div className="text-lg font-medium text-gray-900 dark:text-white">{stats.activeCourses}</div>
                      </dd>
                    </dl>
                  </div>
                </div>
            ...
            <div className="dashboard-stat">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Kommende Termine</dt>
                      <dd>
                        <div className="text-lg font-medium text-gray-900 dark:text-white">{stats.upcomingSessions}</div>
                      </dd>
                    </dl>
                  </div>
                </div>
            ...
            <div className="dashboard-stat">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Offene Verordnungen</dt>
                      <dd>
                        <div className="text-lg font-medium text-gray-900 dark:text-white">{stats.pendingPrescriptions}</div>
                      </dd>
                    </dl>
                  </div>
                </div>
          ...
          <div className="mt-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Aktivitätsübersicht</h2>
                ...
                {[1, 2, 3].map((item) => (
                  <li key={item} className="px-6 py-4 flex items-center">
                    <div className="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                      <div>
                        <p className="text-sm font-medium text-primary dark:text-blue-400 truncate">
                          Kurssitzung
                        </p>

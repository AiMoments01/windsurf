  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg p-4">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="bg-white dark:bg-dark-card shadow overflow-hidden sm:rounded-lg mb-6">
          ...
          <div className="border-t border-gray-200 dark:border-dark-border px-4 py-5 sm:p-0">
            <dl className="sm:divide-y sm:divide-gray-200 dark:sm:divide-dark-border">
              ...
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Rolle</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:mt-0 sm:col-span-2">
              ...
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Konto erstellt</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:mt-0 sm:col-span-2">
